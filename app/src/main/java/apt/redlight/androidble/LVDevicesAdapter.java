package apt.redlight.androidble;
...
public class LVDevicesAdapter extends RecyclerView.Adapter<LVDevicesAdapter.DeviceViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DeviceViewHolder holder, int position) {
        ...
        if (bleDevices.get(position).getBluetoothDevice().getName() == null) {
            ...
            String deviceName = bleDevices.get(position).getBluetoothDevice().getName();
            deviceName = deviceName.replace(BLEManager.DEVICE_NAME_PREFIX_OLD, BLEManager.DEVICE_NAME_PREFIX_NEW);
