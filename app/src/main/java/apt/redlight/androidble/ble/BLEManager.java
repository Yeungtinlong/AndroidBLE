...
import apt.redlight.androidble.util.ClsUtils;
...
public class BLEManager {
    ...
    public static final String DEVICE_NAME_PREFIX_NEW = "AptRedLight";
    public static final String DEVICE_NAME_PREFIX_OLD = "OsteoStrong";
...
//        return deviceName != null;
        return deviceName != null && (deviceName.startsWith(DEVICE_NAME_PREFIX_OLD) || deviceName.startsWith(DEVICE_NAME_PREFIX_NEW));
    }
